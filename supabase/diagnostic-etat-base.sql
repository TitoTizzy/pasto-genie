...
with verif as (
  select 1 as ordre,
    'schema-and-policies.sql' as script,
  ...
  union all select 6,
    'repair-blog-and-competition-engine.sql',
  ...
  union all select 9,
    'repair-admin-match-policies.sql',
  ...
  union all select 10,
    'repair-team-transfer-history.sql',
    exists (select 1 from information_schema.columns
